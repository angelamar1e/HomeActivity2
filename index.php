        ...
        <div class="row justify-content-center">
            ...
            <div class="row m-3 disclaimer">
                <div class="col-8 mx-5">
                    <p>By filling up the form you agree to share your information,
                        you acknowledge and consent to the service's unrestricted use, processing,
                        and sharing of your provided information in accordance with its policies. </p>
                </div>
            </div>
            <div class="row m-3 form justify-content-center">
                <form class="col-3 d-flex flex-column justify-content-center" action="">
                    <div class="row">
                    ...
                    <br>
                    <div class="row">
                        <div class="col-4 fw-bold text-end"><label for="name">Phone Number: </label></div>
